...
(function() {
  ...
  module.exports = new XP.Class('RiotAPI', {
     ...
     * @method getChampions
     * @param {Object} [opt]
     *   @param {boolean} [opt.rankedPlayEnabled]
     *   @param {boolean} [opt.botEnabled]
     *   @param {boolean} [opt.botMmEnabled]
     *   @param {boolean} [opt.active]
     *   @param {boolean} [opt.freeToPlay]
     *   @param {boolean} [opt.id]
    ...
    getChampions: {
      ...
      value: function(opt, cb) {
        ...
        //Setting
        opt.query_ = {};
        opt.query_.rankedPlayEnabled = !!opt.rankedPlayEnabled;
        opt.query_.botEnabled = !!opt.botEnabled;
        opt.query_.botMmEnabled = !!opt.botMmEnabled;
        opt.query_.active = !!opt.active;
    ...
    getMatchListBySummonerId: {
      ...
      value: function(opt, cb) {
        ...
        opt = opt || {};
        opt.group_ = 'match';
        opt.url_ = '/lol/match/{version}/matchlists/by-account/{summonerId}';
        opt.summonerId = opt.id;
