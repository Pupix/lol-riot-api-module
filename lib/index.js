  ...
  module.exports = new XP.Class('RiotAPI', {
    ...
    getRecentGamesBySummonerId: {
      ...
      value: function(opt, cb) {
        ...
        //Preparing
        opt.group_ = 'game';
        opt.url_ = '/api/lol/platform/{version}/game/by-summoner/{summonerId}/recent';
        opt.summonerId = opt.id;
    ...
    getChallengerLeague: {
      ...
      value: function(opt, cb) {
        ...
        opt = opt || {};
        opt.group_ = 'league';
        opt.url_ = '/api/lol/platform/{version}/league/challenger';
    ...
    getMasterLeague: {
      ...
      value: function(opt, cb) {
        ...
        opt = opt || {};
        opt.group_ = 'league';
        opt.url_ = '/api/lol/platform/{version}/league/master';
    ...
    getMatchById: {
      ...
      value: function(opt, cb) {
        ...
        opt = opt || {};
        opt.group_ = 'match';
        opt.url_ = '/api/lol/platform/{version}/match/{matchId}';
        opt.matchId = opt.id;
    ...
    getMatchListBySummonerId: {
      ...
      value: function(opt, cb) {
        ...
        //Preparing
        opt = opt || {};
        opt.group_ = 'matchList';
        opt.url_ = '/api/lol/platform/{version}/matchlist/by-summoner/{summonerId}';
        opt.summonerId = opt.id;
    ...
    getRankedStatsBySummonerId: {
      ...
      value: function(opt, cb) {
        ...
        //Preparing
        opt.group_ = 'stats';
        opt.url_ = '/api/lol/platform/{version}/stats/by-summoner/{summonerId}/ranked';
        opt.summonerId = opt.id;
    ...
    getStatsSummaryBySummonerId: {
      ...
      value: function(opt, cb) {
        ...
        opt = opt || {};
        opt.group_ = 'stats';
        opt.url_ = '/api/lol/platform/{version}/stats/by-summoner/{summonerId}/summary';
        opt.summonerId = opt.id;
    ...
    getSummonersByNames: {
      ...
      value: function(opt, cb) {
        ...
        opt = opt || {};
        opt.group_ = 'summoner';
        opt.url_ = '/api/lol/platform/{version}/summoner/by-name/{summonerNames}';
    ...
    getSummonersByIds: {
      ...
      value: function(opt, cb) {
        ...
        opt = opt || {};
        opt.group_ = 'summoner';
        opt.url_ = '/api/lol/platform/{version}/summoner/{summonerIds}';
        opt.summonerIds = XP.isArray(opt.ids) ? opt.ids.join() : opt.ids;
    ...
    getMasteriesBySummonerIds: {
      ...
      value: function(opt, cb) {
        ...
        opt = opt || {};
        opt.group_ = 'summoner';
        opt.url_ = '/api/lol/platform/{version}/summoner/{summonerIds}/masteries';
        opt.summonerIds = XP.isArray(opt.ids) ? opt.ids.join() : opt.ids;
    ...
    getSummonerNamesByIds: {
      ...
      value: function(opt, cb) {
        ...
        opt = opt || {};
        opt.group_ = 'summoner';
        opt.url_ = '/api/lol/platform/{version}/summoner/{summonerIds}/name';
        opt.summonerIds = XP.isArray(opt.ids) ? opt.ids.join() : opt.ids;
    ...
    getRunesBySummonerIds: {
      ...
      value: function(opt, cb) {
        ...
        opt = opt || {};
        opt.group_ = 'summoner';
        opt.url_ = '/api/lol/platform/v1.4/summoner/{summonerIds}/runes';
        opt.summonerIds = XP.isArray(opt.ids) ? opt.ids.join() : opt.ids;
    ...
    getTeamsBySummonerIds: {
      ...
      value: function(opt, cb) {
        ...
        opt = opt || {};
        opt.group_ = 'team';
        opt.url_ = '/api/lol/platform/{version}/team/by-summoner/{summonerIds}';
        opt.summonerIds = XP.isArray(opt.ids) ? opt.ids.join() : opt.ids;
    ...
    getTeamsByIds: {
      ...
      value: function(opt, cb) {
        ...
        opt = opt || {};
        opt.group_ = 'team';
        opt.url_ = '/api/lol/platform/{version}/team/{teamIds}';
        opt.teamIds = XP.isArray(opt.ids) ? opt.ids.join() : opt.ids;
