...
(function () {
    ...
    module.exports = new XP.Class('RiotAPI', {
        ...
        getChampions: {
            ...
            value: function (opt, cb) {
                ...
                //Checking
                XP.assertArgument(XP.isObject(opt) || XP.isFunction(opt) || XP.isVoid(opt), 1, 'object, function or void');
         ...
         * @param {Object} opt
         *  @param {Object} opt.id
         *  @param {string} [opt.type]- 'RANKED_SOLO_5x5' |'RANKED_TEAM_3x3' |'RANKED_TEAM_5x5'
         *  @param {string} [opt.region]
         *  @param {string} [opt.apiKey]
         * @param {Function} [cb]
         * @promise
         ...
         *  @param {string} [opt.locale]
         *  @param {string} [opt.version]
         *  @param {string} [opt.masteryListData]
         * @param {Function} [cb]
         * @promise
         * @group lolStaticData
         */
        ...
        getStatusByRegion: {
            ...
            value: function (opt, cb) {
                ...
                //Checking
                XP.assertArgument(XP.isObject(opt), 1, 'object');
                XP.assertOption(XP.isString(opt.region), 'opt.region', 'string');
                XP.assertArgument(XP.isFunction(cb) || XP.isVoid(cb), 2, 'function or void');
         ...
         *  @param {string} [opt.region]
         *  @param {string} [opt.apiKey]
         *  @param {string} [opt.includeTimeline]
         * @param {Function} [cb]
         * @promise
         * @group match
         */
         ...
         *  @param {string} [opt.region]
         *  @param {string} [opt.apiKey]
         *  @param {string} [opt.championIds]
         *  @param {string} [opt.rankedQueues]
         *  @param {string} [opt.beginIndex]
         *  @param {string} [opt.endIndex]
         * @param {Function} [cb]
         * @promise
         * @group matchHistory
         */
         ...
         *
         * @method getRankedStatsById
         * @param {Object} opt
         *  @param {string | number} opt.id
         *  @param {string} [opt.region]
         *  @param {string} [opt.apiKey]
         *  @param {string} [opt.season] - 'SEASON3' | 'SEASON2014' | 'SEASON2015'
         * @param {Function} [cb]
         * @promise
         * @group stats
         */
        getRankedStatsBySummonerId: {
            ...
            value: function (opt, cb) {
                ...
                //Setting
                opt.query_ = {};
                opt.query_.season = opt.season || currentSeason;
        ...
        getSummonersByNames: {
            ...
            value: function (opt, cb) {
                ...
                //Checking
                XP.assertArgument(XP.isObject(opt), 1, 'Object');
                XP.assertOption(XP.isString(opt.names) || XP.isNumber(opt.names), 'opt.name', 'string or number');
                XP.assertArgument(XP.isFunction(cb) || XP.isVoid(cb), 2, 'function or void');
        ...
        getSummonersByIds: {
            ...
            value: function (opt, cb) {
                ...
                //Checking
                XP.assertArgument(XP.isObject(opt), 1, 'Object');
                XP.assertOption(XP.isString(opt.ids) || XP.isNumber(opt.ids) || XP.isArray(opt.ids), 'opt.id', 'string, number or array');
                XP.assertArgument(XP.isFunction(cb) || XP.isVoid(cb), 2, 'function or void');
    ...
    // Browserify
    XP.browserify(module.exports, 'RiotAPI');
