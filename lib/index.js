...
(function() {
  ...
  var XP = require('expandjs'),
    ...
    endpoints = {
      br: {
        platform: 'BR1',
        host: 'br1.api.riotgames.com/api'
      },
      eune: {
        platform: 'EUN1',
        host: 'eun1.api.riotgames.com/api'
      },
      euw: {
        platform: 'EUW1',
        host: 'euw1.api.riotgames.com/api'
      },
      jp: {
        platform: 'JP1',
        host: 'jp1.api.riotgames.com/api'
      },
      kr: {
        platform: 'KR',
        host: 'kr.api.riotgames.com/api'
      },
      lan: {
        platform: 'LA1',
        host: 'la1.api.riotgames.com/api'
      },
      las: {
        platform: 'LA2',
        host: 'la2.api.riotgames.com/api'
      },
      na: {
        platform: 'NA1',
        host: 'na1.api.riotgames.com/api'
      },
      oce: {
        platform: 'OC1',
        host: 'oc1.api.riotgames.com/api'
      },
      tr: {
        platform: 'TR1',
        host: 'tr1.api.riotgames.com/api'
      },
      ru: {
        platform: 'RU',
        host: 'ru.api.riotgames.com/api'
      },
      pbe: {
        platform: 'PBE1',
        host: 'pbe1.api.riotgames.com/api'
      },
      global: {
        platform: '',
        host: 'global.api.riotgames.com/api'
      }
    };
  ...
  module.exports = new XP.Class('RiotAPI', {
    ...
    getChampionMastery: {
      ...
      value: function(opt, cb) {
        ...
        opt.url_ = '/champion-mastery/{version}/champions-masteries/by-summoner/{summonerId}';
    ...
    getChampionMasteryById: {
      ...
      value: function(opt, cb) {
        ...
        //Preparing
        opt.group_ = 'championMastery';
        opt.url_ = '/champion-mastery/{version}/champions-masteries/by-summoner{summonerId}/by-champion/{championId}';
        opt.summonerId = opt.id;
    ...
    getChampionMasteryScore: {
      ...
      value: function(opt, cb) {
        ...
        //Preparing
        opt.group_ = 'championMastery';
        opt.url_ = '/champion-mastery/{version}/scores/by-summoner{summonerId}';
        opt.summonerId = opt.id;
    ...
    getRecentGamesBySummonerId: {
      ...
      value: function(opt, cb) {
        ...
        //Preparing
        opt.group_ = 'match';
        opt.url_ = '/lol/match/{version}/matchlists/by-account/{summonerId}/recent';
        opt.summonerId = opt.id;
    ...
    getLeagueBySummonerIds: {
      ...
      value: function(opt, cb) {
        ...
        //Preparing
        opt.group_ = 'league';
        opt.url_ = '/lol/platform/{version}/league/by-summoner/{summonerIds}';
    ...
    getLeagueEntryBySummonerIds: {
      ...
      value: function(opt, cb) {
        ...
        //Preparing
        opt.group_ = 'league';
        opt.url_ = '/lol/platform/{version}/league/by-summoner/{summonerIds}/entry';
        opt.summonerIds = XP.isArray(opt.ids) ? opt.ids.join() : opt.ids;
    ...
    getStatus: {
      ...
      value: function(cb) {
        ...
        opt.url = '/lol/status/{version}/shard-data';
        opt.noSetting_ = true;
    ...
    getMatchListBySummonerId: {
      ...
      value: function(opt, cb) {
        ...
        opt = opt || {};
        opt.group_ = 'match';
        opt.url_ = '/lol/match/{version}/matchlist/by-account/{summonerId}';
        opt.summonerId = opt.id;
    ...
    getSummonerByName: {
      ...
      value: function(opt, cb) {
        ...
        //Checking
        XP.assertArgument(XP.isObject(opt), 1, 'Object');
        XP.assertOption(XP.isString(opt.name) || XP.isArray(opt.name), 'opt.names', 'string');
        XP.assertArgument(XP.isFunction(cb) || XP.isVoid(cb), 2, 'Function or void');
    ...
    getRunesBySummonerId: {
      ...
      value: function(opt, cb) {
        ...
        //Checking
        XP.assertArgument(XP.isObject(opt), 1, 'Object');
        XP.assertOption(XP.isString(opt.id) || XP.isNumber(opt.id), 'opt.ids', 'string');
        XP.assertArgument(XP.isFunction(cb) || XP.isVoid(cb), 2, 'Function or void');
